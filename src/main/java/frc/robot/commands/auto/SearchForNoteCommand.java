...
public class SearchForNoteCommand extends Command {
    ...
    // NOTE: THIS CLASS IS ONLY USEFUL FOR 2024'S GAME
    public SearchForNoteCommand(Swerve swerve, SwerveRequest.FieldCentric fieldCentric) {
        this.swerve = swerve;
