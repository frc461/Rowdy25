...
public final class Constants {
    ...
    public final static class ElevatorConstants {
        ...
        public static double L2_CORAL_FACING_AWAY_ONE_CORAL_FROM_BRANCH;
        public static double L3_CORAL_AT_BRANCH;
        public static double L3_CORAL_ONE_CORAL_FROM_BRANCH;
        public static double L3_CORAL_FACING_AWAY_ONE_CORAL_FROM_BRANCH;
        public static double L4_CORAL_AT_BRANCH;
        public static double L4_CORAL_ONE_CORAL_FROM_BRANCH;
        public static double L4_CORAL_FACING_AWAY_ONE_CORAL_FROM_BRANCH;
