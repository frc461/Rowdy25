...
The classes within `src/main/java/io/github/frc461/rowdy25/` are the core robot software implementation. This documentation covers the main robot lifecycle, the state-machine superstructure, and the modular subsystems that together produce Rowdy25's autonomous and teleoperated behavior.
